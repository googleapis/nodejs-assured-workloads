...
describe('v1.AssuredWorkloadsServiceClient', () => {
    ...
    describe('updateWorkload', () => {
        it('invokes updateWorkload without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.assuredworkloads.v1.UpdateWorkloadRequest());
            request.workload = {};
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.assuredworkloads.v1.Workload());
    ...
    describe('getWorkload', () => {
        it('invokes getWorkload without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.assuredworkloads.v1.GetWorkloadRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createWorkload', () => {
        it('invokes createWorkload without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.assuredworkloads.v1.CreateWorkloadRequest());
            request.parent = '';

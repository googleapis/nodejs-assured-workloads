...
export class AssuredWorkloadsServiceClient {
  ...
  initialize() {
    ...
    const assuredWorkloadsServiceStubMethods =
        ['createWorkload', 'updateWorkload', 'restrictAllowedServices', 'restrictAllowedResources', 'deleteWorkload', 'getWorkload', 'analyzeWorkloadMove', 'listWorkloads'];
 ...
 */
  restrictAllowedServices(
      ...
      Promise<[
        ...
        protos.google.cloud.assuredworkloads.v1beta1.IRestrictAllowedServicesRequest|undefined, {}|undefined
      ]>;
  restrictAllowedServices(
      request: protos.google.cloud.assuredworkloads.v1beta1.IRestrictAllowedServicesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.assuredworkloads.v1beta1.IRestrictAllowedServicesResponse,
          protos.google.cloud.assuredworkloads.v1beta1.IRestrictAllowedServicesRequest|null|undefined,
          {}|null|undefined>): void;
  restrictAllowedServices(
      request: protos.google.cloud.assuredworkloads.v1beta1.IRestrictAllowedServicesRequest,
      callback: Callback<
  ...
  restrictAllowedServices(
    ...
    options.otherArgs.headers = options.otherArgs.headers || {};
    this.initialize();
    return this.innerApiCalls.restrictAllowedServices(request, options, callback);
  }
/**
 ...
 */
  async checkCreateWorkloadProgress(name: string): Promise<LROperation<protos.google.cloud.assuredworkloads.v1beta1.Workload, protos.google.cloud.assuredworkloads.v1beta1.CreateWorkloadOperationMetadata>>{
    ...
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.createWorkload, this._gaxModule.createDefaultBackoffSettings());
